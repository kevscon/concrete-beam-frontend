  ...
  return (
    <div className="container mt-5 d-flex">
      <div style={{ flex: 1 }}>
        ...
        {/* Material Input */}
        <div className="row mb-3 align-items-end">
          <SelectField label="Steel Grade" value={materialInput.steelGrade} onChange={handleSelectChange(setMaterialInput)} id="steelGrade" options={["A615, Grade 40", "A615, Grade 60", "A615, Grade 75", "A615, Grade 80", "A607, Grade 60", "A607, Grade 80", "A1035, Grade 100"]}/>
